...
/**
 * Global class for all AstraCore constants. You can add global constants for your extension into this class.
 */
public final class AstraCoreConstants extends GeneratedAstraCoreConstants
{
	public static final String EXTENSIONNAME = "astracore";


	private AstraCoreConstants()
	{
		//empty
	}
