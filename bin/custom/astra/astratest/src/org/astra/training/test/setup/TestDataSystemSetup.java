 ...
 */
package org.astra.training.test.setup;
...
import org.astra.training.test.constants.AstraTestConstants;
import org.astra.training.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AstraTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/astratest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/astratest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/astratest/import/cstickets.impex");
			...
			importImpexFile(context, "/astratest/import/csquotes.impex");
		}
	}
}
