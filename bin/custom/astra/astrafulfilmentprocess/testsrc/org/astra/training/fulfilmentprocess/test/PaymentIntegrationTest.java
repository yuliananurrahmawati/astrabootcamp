...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		definitonFactory.add("classpath:/astrafulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/astrafulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/astrafulfilmentprocess/test/testCatalog.csv", "windows-1252");
