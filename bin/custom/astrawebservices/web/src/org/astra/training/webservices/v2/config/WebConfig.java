 ...
 */
package org.astra.training.webservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import org.astra.training.webservices.constants.YcommercewebservicesConstants;
import org.astra.training.webservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "astrawebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "astrawebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "astrawebservices.oauth2.tokenUrl";

	private static final String DESC = "astrawebservices.v2.description";
	private static final String TITLE = "astrawebservices.v2.title";
	private static final String VERSION = "astrawebservices.v2.version";
	private static final String LICENSE = "astrawebservices.v2.license";
	private static final String LICENSE_URL = "astrawebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "astrawebservices.content.negotiation.legacy";
